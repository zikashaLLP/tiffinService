...
export default function Header() {
  ...
  return (
    <header className="bg-white py-4 shadow-lg font-sans">
      <div className="container mx-auto px-4 md:px-8 flex justify-between ">
        ...
        <nav className={`${menuClass} md:flex md:items-center md:space-x-6 md:bg-transparent`}>
          <ul className={`md:flex md:flex-row md:space-x-6 md:items-center text-white md:text-gray-400 font-medium text-lg p-10 md:p-0 space-y-4 md:space-y-0`}>
            <li>
              <NavLink
                to="/"
                end
                className={({ isActive }) =>
                  isActive ? "underline text-primary font-semibold" : "text-white md:text-gray-400"
                }
              >
                Home
              </NavLink>
